...
public class PaintballMain extends javax.swing.JFrame {
    ...
    private void reset() {
        ...
        team[1][1] = new Player(1, new Shooter());
        team[1][2] = new Player(1, new Spinner());
        
        team[2][0] = new Player(2, new RandoBot());
        team[2][1] = new Player(2, new RandomWalker());
        team[2][2] = new Player(2, new Sprinkler());
